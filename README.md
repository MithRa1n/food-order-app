ReactFoods is a simple food ordering app built with React, TypeScript, and Context API. Users can browse dishes, add them to the cart, and see a dynamic cart counter.
⚙️ Tech Stack
React + TypeScript
